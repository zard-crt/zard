Page({
  data: {
    statusBarHeight: 44, listHeight: 500, currentFilter: 0,
    filterTabs: ['全部', '进行中', '已完成', '评审中', '已交付'],
    projects: [], loading: false, noMore: false, pageNum: 1
  },
  onLoad() {
  ...
  loadProjects() {
    const allProjects = [
      { id: 1, company: '深圳星河科技有限公司', statusClass: 'ongoing', statusText: '进行中', progress: 65, members: 8, date: '2026-07-10' },
      { id: 2, company: '上海云端网络技术有限公司', statusClass: 'review', statusText: '评审中', progress: 90, members: 6, date: '2026-07-08' },
      { id: 3, company: '北京创新未来数据集团', statusClass: 'completed', statusText: '已完成', progress: 100, members: 12, date: '2026-07-05' },
      { id: 4, company: '广州智造工场实业有限公司', statusClass: 'delivered', statusText: '已交付', progress: 100, members: 5, date: '2026-07-01' },
      { id: 5, company: '杭州数字经济研究院', statusClass: 'ongoing', statusText: '进行中', progress: 42, members: 9, date: '2026-06-28' },
      { id: 6, company: '成都智能硬件开发有限公司', statusClass: 'ongoing', statusText: '进行中', progress: 28, members: 4, date: '2026-06-25' },
    ];
