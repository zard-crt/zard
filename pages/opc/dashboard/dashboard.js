Page({
  data: {
    ...
    pendingItems: [
      { title: '待评审项目', count: 8, url: '/pages/opc/workspace/workspace' },
      { title: '待交付方案', count: 3, url: '/pages/opc/delivery/delivery' }
    ],
    animatedBars: [0, 0, 0, 0, 0]
  },
  onLoad() {
    ...
    setTimeout(() => {
      const heights = this.data.weeklyData.map(d => d.height);
      this.setData({ animatedBars: heights });
    }, 200);
  },
  onPendingTap(e) {
